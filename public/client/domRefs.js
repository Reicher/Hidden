...
export const lobbyMatchStatusTitleEl = document.getElementById(
...
export const lobbyMenuSettingsBtnEl = document.getElementById(
  "lobbyMenuSettingsBtn",
);
export const lobbyMenuCreditsBtnEl = document.getElementById(
  "lobbyMenuCreditsBtn",
);
export const lobbyMenuCloseBtnEl = document.getElementById("lobbyMenuCloseBtn");

// ─── Lobby dialog ─────────────────────────────────────────────────────────────
export const lobbyDialogBackdropEl = document.getElementById(
  "lobbyDialogBackdrop",
);
...
export const lobbyDialogCloseBtnEl = document.getElementById(
  "lobbyDialogCloseBtn",
);
...
export const countdownCharacterCanvasEl = document.getElementById(
  "countdownCharacterCanvas",
);
export const countdownControlsTextEl = document.getElementById(
  "countdownControlsText",
);
export const countdownJoinBtnEl = document.getElementById("countdownJoinBtn");

// ─── In-game HUD ──────────────────────────────────────────────────────────────
export const gameHudEl = document.getElementById("gameHud");
export const crosshairHudEl = document.getElementById("crosshairHud");
export const crosshairCooldownArcEl = document.getElementById(
...
export const debugFrameTimeTextEl =
  document.getElementById("debugFrameTimeText");
...
export const gameMenuSettingsBtnEl = document.getElementById(
  "gameMenuSettingsBtn",
);
export const gameMenuCreditsBtnEl =
  document.getElementById("gameMenuCreditsBtn");
...
// ─── Settings panel ───────────────────────────────────────────────────────────
export const mobileControlsModeBtnEl = document.getElementById(
  "mobileControlsModeBtn",
);
export const fullscreenModeCheckboxEl = document.getElementById(
  "fullscreenModeCheckbox",
);
export const settingsFullscreenHelpEl = document.getElementById(
  "settingsFullscreenHelp",
);
export const lookSensitivityInputEl = document.getElementById(
  "lookSensitivityInput",
);
export const lookSensitivityValueEl = document.getElementById(
  "lookSensitivityValue",
);
export const lookSmoothingToggleBtnEl = document.getElementById(
  "lookSmoothingToggleBtn",
);
...
export const mobileJoystickBaseEl =
  document.getElementById("mobileJoystickBase");
export const mobileJoystickKnobEl =
...
export const mobileLandscapePromptEl = document.getElementById(
...
export const downedCountdownTextEl = document.getElementById(
  "downedCountdownText",
);
...
export const spectatorTargetTextEl = document.getElementById(
  "spectatorTargetText",
);
...
export const spectatorActionRowEl =
  document.getElementById("spectatorActionRow");
